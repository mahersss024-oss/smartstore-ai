...
export const analyzeAIEmployeeMessageSemantics = async (params: {
  ...
  const prompt = JSON.stringify({
    ...
    task: [
      ...
      'customerName may be extracted only when clearly provided.',
      'customerAddress may be extracted only from a shared location map URL or numeric coordinates. Do not convert typed delivery-address text into customerAddress.',
