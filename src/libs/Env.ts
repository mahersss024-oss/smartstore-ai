...
export const Env = createEnv({
  server: {
    ...
    ENABLE_STRIPE_SELF_CHECKOUT: z.enum(['false', 'true']).default('false').transform(value => value === 'true'),
    EVOLUTION_API_BASE_URL: z.url().optional(),
    EVOLUTION_API_KEY: z.string().optional(),
    EVOLUTION_CONNECT_INTEGRATION: z.enum(['WHATSAPP-BAILEYS', 'EVOLUTION']).default('WHATSAPP-BAILEYS'),
    EVOLUTION_INSTANCE_PREFIX: z.string().default('smartstore'),
    ...
    WHAPI_CHANNEL_RENEW_COOLDOWN_HOURS: z.coerce.number().int().min(1).max(168).default(20),
    WHAPI_CHANNEL_RENEW_LOOKAHEAD_HOURS: z.coerce.number().int().min(1).max(720).default(24),
  ...
  runtimeEnv: {
    ...
    ENABLE_STRIPE_SELF_CHECKOUT: process.env.ENABLE_STRIPE_SELF_CHECKOUT,
    EVOLUTION_API_BASE_URL: process.env.EVOLUTION_API_BASE_URL,
    EVOLUTION_API_KEY: process.env.EVOLUTION_API_KEY,
    EVOLUTION_CONNECT_INTEGRATION: process.env.EVOLUTION_CONNECT_INTEGRATION,
    ...
    WHAPI_GATE_API_BASE: process.env.WHAPI_GATE_API_BASE,
    WHAPI_CHANNEL_RENEW_COOLDOWN_HOURS: process.env.WHAPI_CHANNEL_RENEW_COOLDOWN_HOURS,
    WHAPI_CHANNEL_RENEW_LOOKAHEAD_HOURS: process.env.WHAPI_CHANNEL_RENEW_LOOKAHEAD_HOURS,
    WHAPI_MANAGED_CHANNEL_EXTEND_DAYS: process.env.WHAPI_MANAGED_CHANNEL_EXTEND_DAYS,
    WHAPI_PARTNER_API_BASE: process.env.WHAPI_PARTNER_API_BASE,
